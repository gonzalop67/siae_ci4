                ...
                <div class="card card-warning mt-2">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-outline-warning btn-sm" href="<?= base_url(route_to('especialidades')) ?>"><i class="fa fa-fw fa-reply-all"></i> Volver al listado</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="<?= base_url((route_to('especialidades_update'))) ?>" method="POST" autocomplete="off">
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="form-group row <?= session('errors.es_nombre') ? 'has-error' : '' ?>">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="es_nombre" id="es_nombre" value="<?= old('es_nombre') ?? $especialidad->es_nombre ?>" autofocus>
                            ...
                            <div class="form-group row <?= session('errors.es_figura') ? 'has-error' : '' ?>">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="es_figura" id="es_figura" value="<?= old('es_figura') ?? $especialidad->es_figura ?>">
                            ...
                            <div class="form-group row <?= session('errors.es_abreviatura') ? 'has-error' : '' ?>">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="es_abreviatura" id="es_abreviatura" value="<?= old('es_abreviatura') ?? $especialidad->es_abreviatura ?>">
