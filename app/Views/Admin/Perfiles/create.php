                ...
                <div class="card card-success mt-2">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-outline-success btn-sm" href="<?= base_url(route_to('perfiles')) ?>"><i class="fa fa-fw fa-reply-all"></i> Volver al listado</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="<?= base_url((route_to('perfiles_store'))) ?>" method="POST" autocomplete="off">
                        <div class="card-body">
                            <div class="row">
...
<script src="<?php echo base_url(); ?>/public/js/admin/perfiles/crear.js"></script>
