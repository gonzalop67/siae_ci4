                ...
                <div class="card card-success mt-2">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-outline-success btn-sm" href="<?= base_url(route_to('paralelos')) ?>"><i class="fa fa-fw fa-reply-all"></i> Volver al listado</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="<?= base_url((route_to('paralelos_store'))) ?>" method="POST" autocomplete="off">
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="form-group row <?= session('errors.pa_nombre') ? 'has-error' : '' ?>">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pa_nombre" id="pa_nombre" value="<?= old('pa_nombre') ?>" autofocus>
...
<script src="<?php echo base_url(); ?>/public/js/admin/paralelos/crear.js"></script>
